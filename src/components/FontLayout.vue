  ...
  <div class="frontend-layout">
    <div class="navbar-container">
      <div class="brand-section">
        <el-image :src="imageUrl" alt="logo" style="width: 50px; height: 50px;" class="brand-logo"></el-image>
      ...
      <div class="nav-section">
        ...
        <el-button class="logout-bin" v-if="isLogin" @click="logout">退出登录</el-button>
        <template v-else>
...
const isLogin = computed(() => Boolean(userStore.token && userStore.userInfo))
