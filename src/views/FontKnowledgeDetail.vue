    ...
    <div class="articleDetail-container">
        ...
        <div class="content">
            <div class="diary-card">
                ...
                <div class="sub-title">
                    <el-tag type="primary" size="large" class="category-tag">{{detail.categoryName}}</el-tag>
                    <div class="flex-box">
                ...
                <div class="summary-content" v-if="detail.summary">
                    {{ detail.summary }}
                </div>
            ...
            <div class="diary-card">
                ...
                <div class="tags-content">
                    ...
                    <div class="tags-list">
                        <el-tag v-for="tag in detail.tagArray" :key="tag" type="info" size="small" class="tag-item" highlight>{{tag}}</el-tag>
                    </div>
                </div>
            </div>
        </div>
...
import { getKnowledgeDetailApi } from '@/api/fontend'
